...
class Product
{
    ...
    #[Assert\Length(
        min:2,
        max: 200,
        minMessage: 'Le titre doit faire au moin {{ limit }} caractéres',
        maxMessage: 'Le titre ne doit pas faire plus de {{ limit }} caractéres'
    )]
    ...
    #[ORM\Column]
    #[Assert\PositiveOrZero(message:'Le stock ne peux pas être négatif')]
